...
export async function POST(req: Request) {
  ...
  const confirmationText = [
    ...
    ``,
    `If you ever want to stop receiving it, just reply with "unsubscribe" or hit the one-click opt-out at the bottom of any email — we honour it within 72 hours, in line with DPDP 2023.`,
    ``,
    `— Qlarify Health`,
  ...
  const internalText = [
    ...
    `Consent:  granted (DPDP-compliant opt-in)`,
    `Source:   ${site.url}`,
    ``,
    `—`,
