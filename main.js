...
(function(){
  ...
  var valid=['home','video','seo','paid','social','email','opd','campaigns','about','contact','audit','privacy','terms','blog','blog-hospital-marketing','blog-opd-footfall','blog-video-marketing','blog-hospital-seo','blog-healthcare-agency','blog-social-media-hospitals','blog-vs-generic-agencies','blog-in-house-vs-agency','blog-hospital-video-production-india','blog-hospital-content-marketing','blog-patient-decision-videos','blog-hospital-video-appointments','blog-why-hospital-videos-dont-convert','glossary'];
