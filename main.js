var pageMeta={
  ...
  video:{title:'Video as Infrastructure for Hospitals | Qlarify Health',desc:'Structured healthcare video production mapped to the patient decision journey. From symptom explainers to 3D animations — build trust and drive 4x more appointment conversions.'},
  ...
  email:{title:'Hospital Email & WhatsApp Campaigns | Qlarify Health',desc:'Reactivate your existing patient database with structured email and WhatsApp campaigns. Appointment reminders, health tips, and follow-ups that drive repeat visits at 5x lower cost.'},
  ...
  about:{title:'About Qlarify Health — Our Story & Team',desc:'Built from inside India\'s leading hospital systems. Meet the healthcare marketing team that has produced 1000+ medical videos and grown OPD footfall for top hospital brands.'},
  contact:{title:'Schedule a Strategy Conversation | Qlarify Health',desc:'Let\'s talk about your hospital\'s marketing challenges. Book a free 30-minute strategy conversation with our healthcare marketing specialists — no obligations, just clarity.'},
  ...
  'blog-video-marketing':{title:'Video Marketing for Hospitals: Why It Works | Qlarify',desc:'Why structured video systems outperform random content in healthcare. Map video to the patient decision journey and drive 4x more appointment conversions for your hospital.'},
...
// Path routing
var blogSlugs={'what-is-hospital-marketing':'blog-hospital-marketing','increase-opd-footfall':'blog-opd-footfall','video-marketing-hospitals':'blog-video-marketing','hospital-seo-guide':'blog-hospital-seo','healthcare-vs-general-agency':'blog-healthcare-agency','social-media-strategy-hospitals':'blog-social-media-hospitals','qlarify-health-vs-generic-agencies':'blog-vs-generic-agencies','in-house-vs-healthcare-agency':'blog-in-house-vs-agency'};
var blogIds={'blog-hospital-marketing':'blog/what-is-hospital-marketing','blog-opd-footfall':'blog/increase-opd-footfall','blog-video-marketing':'blog/video-marketing-hospitals','blog-hospital-seo':'blog/hospital-seo-guide','blog-healthcare-agency':'blog/healthcare-vs-general-agency','blog-social-media-hospitals':'blog/social-media-strategy-hospitals','blog-vs-generic-agencies':'blog/qlarify-health-vs-generic-agencies','blog-in-house-vs-agency':'blog/in-house-vs-healthcare-agency'};
...
(function(){
  ...
  var valid=['home','video','seo','paid','social','email','opd','about','contact','privacy','terms','blog','blog-hospital-marketing','blog-opd-footfall','blog-video-marketing','blog-hospital-seo','blog-healthcare-agency','blog-social-media-hospitals','blog-vs-generic-agencies','blog-in-house-vs-agency','glossary'];
...
(function(){
  ...
  var pageTitles={
    ...
    contact:'Schedule a Strategy Call | Qlarify Health',
